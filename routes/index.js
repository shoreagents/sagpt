...
export const runWithEmbeddings = async (question) => {
  ...
  const outlineTemplate = `Given the title above, create an outline format with headings and sub-headings if needed. Start with the title and then the outline
